                        ...
                        <div className="center" style={{ width: "100%", marginTop: "5px" }}>
                            ...
                            <div className="onerow" style={{ width: "94%" }}>
                                ...
                                <div className="input-box" style={{ width: "100%", minWidth: "100px" }}>
                                    ...
                                    <input className="def" list="inni-kandydaci" style={{ color: colors.header }} value={additionalCandidateName} onChange={(e) => { setAdditionalCandidateName(e.target.value) }} required />
